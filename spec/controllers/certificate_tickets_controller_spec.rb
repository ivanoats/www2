  ...
  describe "Anybody" do
    ...
    describe "responding to GET show" do
      ...
      it "should expose the requested certificate_ticket as @certificate_ticket" do
        CertificateTicket.expects(:find).with("37").returns(mock_certificate_ticket)
        get :show, :id => "37"
      ...
      describe "with mime type of xml" do
        ...
        it "should render the requested certificate_ticket as xml" do
          ...
          CertificateTicket.expects(:find).with("37").returns(mock_certificate_ticket)
          mock_certificate_ticket.expects(:to_xml).returns("generated XML")
          get :show, :id => "37"
    ...
    describe "responding to GET new" do
      ...
      it "should expose a new certificate_ticket as @certificate_ticket" do
        CertificateTicket.expects(:new).returns(mock_certificate_ticket)
        get :new
        assigns[:certificate_ticket].should equal(mock_certificate_ticket)
      end
    ...
    describe "responding to POST create" do
      ...
      describe "with valid params" do
        ...
        it "should expose a newly created certificate_ticket as @certificate_ticket" do
          CertificateTicket.expects(:new).with({'these' => 'params'}).returns(mock_certificate_ticket(:save => true))
          post :create, :certificate_ticket => {:these => 'params'}
          assigns(:certificate_ticket).should equal(mock_certificate_ticket)
        end

        it "should redirect to the created certificate_ticket" do
          CertificateTicket.stubs(:new).returns(mock_certificate_ticket(:save => true))
          post :create
      ...
      describe "with invalid params" do
        ...
        it "should expose a newly created but unsaved certificate_ticket as @certificate_ticket" do
          CertificateTicket.stubs(:new).with({'these' => 'params'}).returns(mock_certificate_ticket(:save => false))
          post :create, :certificate_ticket => {:these => 'params'}
          assigns(:certificate_ticket).should equal(mock_certificate_ticket)
        end

        it "should re-render the 'new' template" do
          CertificateTicket.stubs(:new).returns(mock_certificate_ticket(:save => false))
    ...
    describe "responding to PUT update" do
      ...
      describe "with valid params" do
        ...
        it "should update the requested certificate_ticket" do
          CertificateTicket.expects(:find).with("37").returns(mock_certificate_ticket)
          mock_certificate_ticket.expects(:update_attributes).with({'these' => 'params'})
          put :update, :id => "37", :certificate_ticket => {:these => 'params'}
        end

        it "should expose the requested certificate_ticket as @certificate_ticket" do
          CertificateTicket.stubs(:find).returns(mock_certificate_ticket(:update_attributes => true))
      ...
      describe "with invalid params" do
        ...
        it "should expose the certificate_ticket as @certificate_ticket" do
          CertificateTicket.stubs(:find).returns(mock_certificate_ticket(:update_attributes => false))
          put :update, :id => "1"
          assigns(:certificate_ticket).should equal(mock_certificate_ticket)
        end
  ...
  describe "Only the administrator" do
    ...
    describe "responding to GET index" do
      ...
      it "should expose all certificate_tickets as @certificate_tickets" do
        CertificateTicket.expects(:find).with(:all).returns([mock_certificate_ticket])
        get :index
      ...
      describe "with mime type of xml" do
        ...
        it "should render all certificate_tickets as xml" do
          request.env["HTTP_ACCEPT"] = "application/xml"
          CertificateTicket.expects(:find).with(:all).returns(certificate_tickets = mock("Array of CertificateTickets"))
          certificate_tickets.expects(:to_xml).returns("generated XML")
          get :index
          response.body.should == "generated XML"
        end
    ...
    describe "responding to DELETE destroy" do
       ...
       it "should destroy the requested certificate_ticket" do
         CertificateTicket.expects(:find).with("37").returns(mock_certificate_ticket)
         mock_certificate_ticket.expects(:destroy)
         delete :destroy, :id => "37"
       end

       it "should redirect to the certificate_tickets list" do
         CertificateTicket.stubs(:find).returns(mock_certificate_ticket(:destroy => true))
         delete :destroy, :id => "1"
