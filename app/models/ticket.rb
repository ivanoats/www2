class Ticket < ActiveRecord::Base
  ...
  # TODO below should be true only for technical tickets
  validates_presence_of :cpanel_username, :on => :create, :message => "can't be blank - please check cpanel before submitting a ticket"
  
  # no longer require password 
  #validates_presence_of :cpanel_password, :on => :create, :message => "can't be blank - please check cpanel before submitting a ticket"
